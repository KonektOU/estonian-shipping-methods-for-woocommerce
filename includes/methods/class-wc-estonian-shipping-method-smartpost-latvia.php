 ...
 *
 * @class     WC_Estonian_Shipping_Method_Smartpost_Latvia
 * @extends   WC_Shipping_Method
 * @category  Shipping Methods
 * @package   Estonian_Shipping_Methods_For_WooCommerce
 */
class WC_Estonian_Shipping_Method_Smartpost_Latvia extends WC_Estonian_Shipping_Method_Smartpost {
	...
	public function __construct() {
		// Identify method.
		$this->id           = 'smartpost_latvia';
		$this->method_title = __( 'Smartpost Latvia', 'wc-estonian-shipping-methods' );
